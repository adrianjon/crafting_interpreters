...
// include: C:\Users\adrian\AppData\Local\Temp\tmpozr5stqh.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'demo/index.data';
...
Module['FS_createPath']("/", "demo", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_demo/index.data');
      }
      Module['addRunDependency']('datafile_demo/index.data');
    ...
    loadPackage({"files": [{"filename": "/demo/dragon.obj", "start": 0, "end": 402720}, {"filename": "/demo/shader.wgsl", "start": 402720, "end": 404142}], "remote_package_size": 404142});

  })();

// end include: C:\Users\adrian\AppData\Local\Temp\tmpozr5stqh.js
// include: C:\Users\adrian\AppData\Local\Temp\tmplvi_fpig.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\adrian\AppData\Local\Temp\tmplvi_fpig.js
// include: C:\Users\adrian\AppData\Local\Temp\tmp3ltxqla8.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\adrian\AppData\Local\Temp\tmp3ltxqla8.js
...
var _set_canvas_size = Module['_set_canvas_size'] = makeInvalidEarlyAccess('_set_canvas_size');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['set_canvas_size'] != 'undefined', 'missing Wasm export: set_canvas_size');
  ...
  _set_canvas_size = Module['_set_canvas_size'] = createExportWrapper('set_canvas_size', 2);
