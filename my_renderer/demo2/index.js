...
// include: C:\Users\adrian\AppData\Local\Temp\tmphd19joq1.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'demo2/index.data';
...
Module['FS_createPath']("/", "demo2", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_demo2/index.data');
      }
      Module['addRunDependency']('datafile_demo2/index.data');
    ...
    loadPackage({"files": [{"filename": "/demo2/cube.obj", "start": 0, "end": 416}, {"filename": "/demo2/dragon.obj", "start": 416, "end": 403136}], "remote_package_size": 403136});

  })();

// end include: C:\Users\adrian\AppData\Local\Temp\tmphd19joq1.js
...
function copy_buffer_to_canvas(buffer,width,height) { const canvas = document.getElementById('canvas'); const ctx = canvas.getContext('2d'); const imageData = ctx.createImageData(width, height); const data = imageData.data; const bufferView = HEAPU8.subarray(buffer, buffer + width * height * 4); data.set(bufferView); ctx.putImageData(imageData, 0, 0); }
