...
static const char* ast_file = "ast.h";
...
//     print("\n");
    ...
    memory_free(&target_file_h.buffer);
    memory_free(&p_ast_file_ptr);
...
//file_t* p_ast_file_ptr = write_file("./lox/poop", sb.buffer, sb.length);
    ...
    memory_free(&target_file_c.buffer);
    memory_free(&p_ast_file_c_ptr);
